...
net1 = feedforwardnet([25,25,25,25]);
...
net2 = feedforwardnet([100,50,25,25]);
...
net3 = feedforwardnet([100,50,50,25]);
...
net5 = feedforwardnet([200,100,100,50]);
...
net6 = feedforwardnet([400,200,100,50]);
...
C = categorical({'25/25/25/25','100/50/25/25',...
    '100/50/50/25','50/100/100/200',...
    '200/100/100/50','400/200/100/50'});
C = reordercats(C,{'25/25/25/25','100/50/25/25',...
    '100/50/50/25','50/100/100/200',...
    '200/100/100/50','400/200/100/50'});
