...
plot(noiseLevels,percError3*100,'-*','LineWidth',1.5,...
    'color',lineStyles(3,:));
plot(noiseLevels,percError4*100,'-.x','LineWidth',1.5,...
    'color',lineStyles(4,:));
...
xlabel('Noise Level');
ylabel('Errors');
legend('10/25/25','25/25/25',...
    '50/25/25','80/25/25','80/50/25',...
    'Location','SouthEast')
